   ...
   const myLoader = ({ src, width, quality }) => {
	...
	return (
      ...
      <section className="employee-single">
						...
						<ul className="management__sub-list">
							<li className="management__sub-item management__sub-item-single">
								...
								<div className="social-set__box ">
									<ul className="management__social__list social-set__box_single">
									...
									<div className="show__social single_about">
										<svg
							...
							<li className="management__sub-item ">
								<p className="management__discription">
									...
									<strong className="management__name">
										Yutuqlari: <span className='mana_span'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic, voluptatem!</span>
									</strong>
									<strong className="management__name">
										Ilmiy darajasi: <span className='mana_span'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic, voluptatem!</span>
									</strong>
								</p>
								<div className="management_phone">
									<h3 className="management_phone-heading">
										Tel:
									</h3>
										<a
											className="management_phone__number"
											href="tel:+998712443581"
										>
											+998 (71) 2443581
										</a>
									</div>
									<div className="management_email__address">
									<h3 className="management_phone-heading">
										E-mail:
									</h3>
										<a
											href="mailto:ziyo-zukko@gmail.com"
											className="management_email"
										>
											ziyo-zukko@gmail.com
										</a>
									</div>
									<div className="management_work__time">
									<h3 className="management_phone-heading">
										Qabul kunlari:
									</h3>
										<time className="management_time__info">
											Du-Sha 8:00 - 18:00
										</time>
									</div>
							</li>
         ...
         <div className="employee-single__info__box">
            <h2 className="employee-single__heading">Faoliyat</h2>
            <p className="employee-single__discription">
               Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptate labore laudantium quod, optio magni vel harum possimus asperiores at eligendi fuga aliquam architecto sunt, sint porro laboriosam sequi! Ut cum ipsam iste quisquam, harum quaerat assumenda corporis mollitia provident dolore esse fugit! Voluptates, quam! Incidunt iusto, fugit libero deserunt nulla a, distinctio corrupti ex atque, molestias reprehenderit saepe autem sunt ipsum quas temporibus. Aspernatur quibusdam ab culpa, ut iusto fuga obcaecati harum error consectetur illum nisi autem dignissimos expedita perspiciatis odit sunt. Maxime quae ullam voluptatem molestias cupiditate officiis necessitatibus ut repellendus, quo quos sit voluptatum, temporibus dolorum aperiam corporis.
            </p>
         </div>
		</section>
